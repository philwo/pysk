...
vps_phpconfig_2.name = u'production'
...
vps_phpconfig_2.allow_call_time_pass_reference = False
vps_phpconfig_2.error_reporting = u'E_ALL & ~E_DEPRECATED'
vps_phpconfig_2.display_errors = False
vps_phpconfig_2.display_startup_errors = False
vps_phpconfig_2.log_errors = True
vps_phpconfig_2.track_errors = False
vps_phpconfig_2.html_errors = False
vps_phpconfig_2.session_bug_compat_42 = False
vps_phpconfig_2.session_bug_compat_warn = False
